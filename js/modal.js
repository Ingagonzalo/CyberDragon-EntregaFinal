...
document.querySelector("#aCompras").onclick = function () {
	document.querySelector("#contenedor-compras").style.display = "flex"	
    document.querySelector(".fondoComprar").style.display = "block"	
    document.querySelector(".modal-contenedor").style.display = "none"	
}


document.querySelector("#cerrarCompra").onclick = function () {
